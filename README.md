...
- **Embedded MCP server** with optional bearer-token *or* full OAuth 2.1 + PKCE auth, **59 tools** (see [Tool surface](#tool-surface)) — including a raw `cdp_send` escape hatch giving full Chrome DevTools Protocol access
